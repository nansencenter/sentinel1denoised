...
# import data
npzFilesAll = sorted(glob.glob('%s/%s_%s_GRDM_1SDH_*_noiseScaling.npz' % (in_path, platform, mode)))
...
plt.tight_layout()
plt.savefig('%s_%s_%s_scale_noise.png' % (platform, mode, region), bbox_inches='tight', dpi=600)
